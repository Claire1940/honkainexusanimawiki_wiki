...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Honkai Nexus Anima Wiki",
    description: "Read the Terms of Service for Honkai Nexus Anima Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Honkai Nexus Anima Wiki",
      description: "Terms and conditions for using Honkai Nexus Anima Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Honkai Nexus Anima Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Honkai Nexus Anima Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Honkai Nexus Anima Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Honkai Nexus Anima Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the game "Honkai Nexus Anima". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and strategy walkthroughs</li>
              <li>Anima companion and character guides</li>
              <li>Codes and Evolution Test beta information</li>
              <li>Tier lists and team-building tips</li>
              <li>Achievement and progression walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Honkai Nexus Anima Wiki is NOT affiliated with, endorsed by, or associated with
              HoYoverse or the official developers of Honkai Nexus Anima. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Honkai Nexus Anima Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of HoYoverse and/or the developers of Honkai Nexus Anima. We use such
            ...
            <ul>
              ...
              <li><strong>Beta Availability:</strong> Evolution Test schedules and game updates may change without notice. We are not responsible for beta access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, HONKAI NEXUS ANIMA WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Discord, Reddit, and social media platforms,
            ...
            <p>
              ...
              you and Honkai Nexus Anima Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@honkainexusanimawiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@honkainexusanimawiki.wiki</a>
            </p>
            <p>
