...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Honkai Nexus Anima Wiki',
    description: 'Copyright and intellectual property information for Honkai Nexus Anima Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Honkai Nexus Anima Wiki',
      description: 'Copyright and intellectual property information for Honkai Nexus Anima Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Honkai Nexus Anima Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Honkai Nexus Anima Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Honkai Nexus Anima Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <p>
              ...
              affiliation with Honkai Nexus Anima Wiki.
            </p>
            ...
            <p>
              ...
              Honkai Nexus Anima Wiki<br />
              Email: <a href="mailto:dmca@honkainexusanimawiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@honkainexusanimawiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Honkai Nexus Anima Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Honkai Nexus Anima Wiki (honkainexusanimawiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@honkainexusanimawiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@honkainexusanimawiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@honkainexusanimawiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@honkainexusanimawiki.wiki</a>
            </p>
            <p>
